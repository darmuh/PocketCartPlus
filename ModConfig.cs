...
namespace PocketCartPlus
{
    internal static class ModConfig
    {
        ...
        internal static void Init()
        {
            ...
            CartItemsMinPrice = Plugin.instance.Config.Bind("Keep Items Upgrade", "Minimum Price", 6000f, new ConfigDescription("Set this as the minimum base price for this item (before multipliers)", new AcceptableValueRange<float>(1000f, 90000f)));
            CartItemsMaxPrice = Plugin.instance.Config.Bind("Keep Items Upgrade", "Maximum Price", 11000f, new ConfigDescription("Set this as the maximum base price for this item (before multipliers)", new AcceptableValueRange<float>(1000f, 90000f)));
            ...
            PlayerSafetyCheck = Plugin.instance.Config.Bind("Keep Items Upgrade", "Player Safety Check", false, "When enabled, ensures living players are ignored during pocket cart equip to prevent player death.\nWhen disabled, players will be sent to the void. (The void can be locked by the void remote item)");
            ...
            PlusItemMinPrice = Plugin.instance.Config.Bind("Cart Plus Item", "Minimum Price", 30000f, new ConfigDescription("Set this as the minimum base price for this item (before multipliers)", new AcceptableValueRange<float>(1000f, 90000f)));
            PlusItemMaxPrice = Plugin.instance.Config.Bind("Cart Plus Item", "Maximum Price", 60000f, new ConfigDescription("Set this as the maximum base price for this item (before multipliers)", new AcceptableValueRange<float>(1000f, 90000f)));
            ...
            VoidRemoteMinPrice = Plugin.instance.Config.Bind("Void Remote Item", "Minimum Price", 1000f, new ConfigDescription("Set this as the minimum base price for this item (before multipliers)", new AcceptableValueRange<float>(1000f, 90000f)));
            VoidRemoteMaxPrice = Plugin.instance.Config.Bind("Void Remote Item", "Maximum Price", 2500f, new ConfigDescription("Set this as the maximum base price for this item (before multipliers)", new AcceptableValueRange<float>(1000f, 90000f)));
        }
    }
}
